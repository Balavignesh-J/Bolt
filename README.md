...
[Bolt App](https://bolt-bv.vercel.app/)
...
_(Note: Exact payload schemas can be inspected in the respective controller files)._
...
- **Lazy DB Connections:** The backend establishes a database connection on the _first request_ rather than at boot, optimizing it for cold starts in serverless deployment environments like Vercel.
